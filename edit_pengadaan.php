...
$query="SELECT pengadaan.*, pegawai.NAMAPEGAWAI FROM pengadaan LEFT JOIN pegawai ON pengadaan.IDPEGAWAI = pegawai.IDPEGAWAI WHERE IDPENGADAAN='$IDPENGADAAN'";
		...
		<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					...
					<form action="updatepengadaan.php" method="post">
						...
						<div class="form-group row">
							...
							<input class="form-control" type="text" name="NAMAPEGAWAI" value="<?php echo $NAMAPEGAWAI; ?>" readOnly>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">TGLPENGADAAN</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" name="TGLPENGADAAN" value="<?php echo date('d-m-Y', strtotime($TGLPENGADAAN)); ?>">
							</div>
						</div>
