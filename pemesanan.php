					...
					<div class="row">
						<table class="data-table stripe hover nowrap">
							...
							<?php include"koneksi.php";                
                              ...
                              $sql = mysqli_query($kon,"SELECT pengadaan.*, supplier.NAMASUPPLIER, pegawai.NAMAPEGAWAI FROM pengadaan LEFT JOIN supplier ON supplier.IDSUPPLIER = pengadaan.IDSUPPLIER LEFT JOIN pegawai ON pegawai.IDPEGAWAI = pengadaan.IDPEGAWAI  LEFT JOIN pembayaran_pengadaan on pembayaran_pengadaan.IDPENGADAAN = pengadaan.IDPENGADAAN where pengadaan.status='1' AND pengadaan.STATUS_PEMBAYARAN IS NULL");
                            ...
                            <td><?php IF($rr['STATUS_PEMBAYARAN']== null) echo "Belum dibayar";?></td>
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<a class="dropdown-item" href="detail_pembayaran.php?id=<?php echo $rr['IDPENGADAAN']; ?>"><i class="fa fa-pencil"></i> Edit</a>
												<a class="dropdown-item" href="hapus_pengadaan.php?id=<?php echo $rr['IDPENGADAAN']; ?>"><i class="fa fa-trash"></i> Delete</a>
											</div>
										</div>
									</td>
								</tr>
