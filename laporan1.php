				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					...
					<div class="row">
                      ...
                      <div class="modal-body">
                        <form method="GET" action="laporan1.php">
                            <div class="box-body">
                            ...
                            <div class="box-footer">            
                             ...
                             <a class="btn btn-primary" href="printlaporan.php?start_date=<?php echo @$start_date; ?>&finish_date=<?php echo @$finish_date; ?>"  target="_blank">Print</a>                
                            </div>
                          </form>
                      </div>
					  	</div>	
