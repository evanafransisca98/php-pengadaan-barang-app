		...
		<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					...
					<a href="#" class="btn btn-primary" data-toggle="modal" data-target="#modal_tambah_data"  type="button">Tambah Data</a>	
					</div>
					<div class="row">
						<table class="data-table stripe hover nowrap">
							...
							<?php include"koneksi.php";                
                              ...
                              $sql = mysqli_query($kon,"SELECT barang.*, jenisbarang.JENISBARANG, stok.STOK FROM barang left join jenisbarang on barang.IDJENISBARANG=JENISBARANG.IDJENISBARANG left join stok ON barang.IDBARANG=stok.IDBARANG");
							...
							<td><?php echo  $no++; ?></td>
							<td><?php echo  $rr['JENISBARANG']; ?></td>
							<td><?php echo  $rr['NAMABARANG']; ?></td>
                            <td><?php echo  $rr['HARGAJUALBARANG']; ?></td>
                            <td><?php echo $rr['STOK'];?></td>
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<a class="dropdown-item" href="edit_barang.php?id=<?php echo $rr['IDBARANG']; ?>"><i class="fa fa-pencil"></i> Edit</a>
												<a class="dropdown-item" href="hapus_barang.php?id=<?php echo $rr['IDBARANG']; ?>"><i class="fa fa-trash"></i> Delete</a>
											</div>
										</div>
									</td>
								</tr>
									...
									<div class="modal-content">
										...
										<form action="tambah_barang.php" method="post">
											...
											<div class="form-group row">
												...
												<div class="col-sm-12 col-md-10">
													<input class="form-control" type="text" name="TGLSTOK" value="<?php echo date('d-m-y') ?>">
												</div>
											</div>
											<div class="form-group row">
