					...
					<div class="row">
						<table class="data-table stripe hover nowrap">
							...
							<?php include"koneksi.php";                
                              ...
                              $sql = mysqli_query($kon,"SELECT pengadaan.IDPENGADAAN,pengadaan.TGLPENGADAAN, barang.NAMABARANG, detail_pengadaan.JUMLAHBARANGPENGADAAN, detail_pengadaan.HARGABELI, detail_pengadaan.SUBTOTALPENGADAAN, pembayaran_pengadaan.TGLBAYARPENGADAAN from pengadaan left join detail_pengadaan on pengadaan.IDPENGADAAN = detail_pengadaan.IDPENGADAAN left join barang on barang.IDBARANG = detail_pengadaan.IDBARANG left join pembayaran_pengadaan on pembayaran_pengadaan.IDPENGADAAN=pengadaan.IDPENGADAAN");
                            ...
                            <td><?php echo date(now()), $rr['TGLBAYARPENGADAAN'];?></td>
