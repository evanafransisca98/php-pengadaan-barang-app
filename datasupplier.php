		...
		<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					...
					<a href="#" class="btn btn-primary" data-toggle="modal" data-target="#modal_tambah_data_supplier" type="button">Tambah Data</a>	
					</div>
					<div class="row">
						<table class="data-table stripe hover nowrap">
							...
							<td><?php echo  $rr['ALAMATSUPPLIER']; ?></td>
                            <td><?php echo  $rr['TELPSUPPLIER']; ?></td>
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<a class="dropdown-item" href="edit_supplier.php?id=<?php echo $rr['IDSUPPLIER']; ?>"><i class="fa fa-pencil"></i> Edit</a>
												<a class="dropdown-item" href="hapus_supplier.php?id=<?php echo $rr['IDSUPPLIER']; ?>"><i class="fa fa-trash"></i> Delete</a>
											</div>
										</div>
									</td>
								</tr>
...
<div class="col-md-4 col-sm-12">
						<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
							...
							<div class="modal fade bs-example-modal-lg" id="modal_tambah_data_supplier" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
										...
										<form action="tambah_supplier.php" method="post">
											<div class="form-group row">
												...
												<div class="col-sm-12 col-md-10">
													<input class="form-control" type="text" name="IDSUPPLIER" readonly="true">
												</div>
											</div>
											<!-- isi kututup -->
											 ...
											 <div class="form-group row">
												...
												<div class="col-sm-12 col-md-10">
													<input class="form-control" type="text" name="NAMASUPPLIER"> 
											...
											<div class="form-group row">
												...
												<div class="col-sm-12 col-md-10">
													<input class="form-control" type="text" name="ALAMATSUPPLIER">
												</div>
											</div>
											<div class="form-group row">
												<label class="col-sm-12 col-md-2 col-form-label">Telp Supplier</label>
												<div class="col-sm-12 col-md-10">
													<input class="form-control" type="text" name="TELPSUPPLIER">
												</div> 
