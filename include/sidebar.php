	<div class="left-side-bar">
		<div class="brand-logo">
			<center>
				<img src="vendors/images/car1.png" alt="">
			</center>
		</div>
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						<center>
						<li><a href="pemesanan.php">Pemesanan</a>
						</li>
						</center>

						<a href="javascript:;" class="dropdown-toggle">
							<span class="fa fa-table"></span><span class="mtext">Data</span>
						</a>
						<ul class="submenu">
							
							<li><a href="databarang.php">Data Barang</a>
							</li>
							...
							<li><a href="pengadaanbarang.php">Pengadaan Barang</a></li>
						</ul>
						<center>
						<li><a href="laporan1.php">Laporan</a>
						</li>
						</center>
