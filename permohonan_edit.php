				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					...
					<form action="updatepengadaan.php" method="post">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
							   <select class="form-control" name="IDPEGAWAI"  disabled>
	                            <?php
	                                     $sql = mysqli_query($kon,"SELECT * FROM pegawai");
	                                     while ($rr=mysqli_fetch_assoc($sql)) {
	                      
	                            ?>
									<option value="<?php echo $rr['IDPEGAWAI']; ?>"><?php echo $rr['NAMAPEGAWAI']; ?></option>
						...
						<a  class="btn btn-primary" href="approve.php?id=<?php echo $IDPENGADAAN; ?>"> Approve</a>
					    <!-- Large modal -->
